...
public class EticketKeretaServiceImpl implements EticketKeretaService {
    ...
    private static Table container1Page2(TransactionDto transactionDto, StylePdfService stylePdfService, PdfFont plusJakarta, MessageSource messageSource, int page) throws MalformedURLException {
