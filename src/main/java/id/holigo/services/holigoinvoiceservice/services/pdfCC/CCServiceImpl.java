...
public class CCServiceImpl implements CCService {
    ...
    @Override
    public void invoiceCreditCard(TransactionDto transactionDto, HttpServletResponse response, StylePdfService stylePdfService) throws MalformedURLException {
        //starter pack
        ...
        String subTitle = messageSource.getMessage("invoice.subtitle-CC", null, LocaleContextHolder.getLocale());
        ...
        String cusNum = messageSource.getMessage("invoice.generic-card-number", null, LocaleContextHolder.getLocale());
        tblDetailPemesanan.addCell(stylePdfService.getTextDetail(cusNum, plusJakarta)); //col 2
        tblDetailPemesanan.addCell(stylePdfService.getTextDetail("", plusJakarta));

        String idPelanggan = messageSource.getMessage("invoice.CC-bank", null, LocaleContextHolder.getLocale());
...
//        Detail Produk title
        Table detailProdukTbl = new Table(new float[]{60, 200, 240, col,col});
...
//        String product = "Produk";
        ...
        String nominalHead = messageSource.getMessage("invoice.generic-nominal", null, LocaleContextHolder.getLocale());
        detailProdukTbl.addCell(stylePdfService.getHeaderTextCell(nominalHead, plusJakarta).setTextAlignment(TextAlignment.CENTER)); //col4
...
//        Detail Produk output
        ...
        String nominal = transactionDto.getDetail().get("billAmount").asText();
        detailProdukTbl.addCell(stylePdfService.getDetailProdukOutput(nominal, plusJakarta).setTextAlignment(TextAlignment.CENTER)); // col 4
