...
@Slf4j
public class EwallServiceImpl implements EwallService {

    @Autowired
    private final MessageSource messageSource;

    @Override
    public void invoiceEwall(TransactionDto transactionDto, HttpServletResponse response, StylePdfService stylePdfService) throws MalformedURLException {
        //starter pack
...
//        Size Table Declarartion
        ...
        String subTitle = messageSource.getMessage("invoice.subtitle-ewall", null, LocaleContextHolder.getLocale());
...
//        Detail Produk output
        ...
        double billAmount = transactionDto.getDetail().get("billAmount").floatValue();
        double fareAmount;
        ...
        detailProdukTbl.addCell(stylePdfService.getDetailProdukOutput(transactionDto.getDetail().get("nominalName").asText(), plusJakarta)); // col 4
...
//        Bill / Price / harga
        ...
        System.out.println("final prce : " + finalPrice);
        System.out.println("billAmount : " + billAmount);
        System.out.println("adminAmount :" + adminAmount);
        System.out.println("serviceFeeAmoung : " + serviceFeeAmoung);
