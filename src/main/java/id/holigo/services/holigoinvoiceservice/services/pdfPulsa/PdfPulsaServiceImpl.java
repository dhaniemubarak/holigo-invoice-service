...
@Slf4j
public class PdfPulsaServiceImpl implements PdfPulsaService {
...
//        Size Table Declarartion
        ...
        // - - - - - HEADER  - - - - -
        String title = messageSource.getMessage("invoice.title-pulsa", null, LocaleContextHolder.getLocale());
...
//        String transactionId = "ID Transaksi";
        ...
        disclaimer.addCell(new Cell().add("").setHeight(3).setBorder(Border.NO_BORDER));
        String disclaimerContain = messageSource.getMessage("invoice.pulsa-disclaimer", null, LocaleContextHolder.getLocale());
        ...
        String invoiceNumberStr = messageSource.getMessage("invoice.number-pulsa", null, LocaleContextHolder.getLocale());
        ...
        String bookingDetails = messageSource.getMessage("invoice.detail-order-pulsa", null, LocaleContextHolder.getLocale());
        ...
        String phoneNumber = messageSource.getMessage("invoice.pulsa-phone-number", null, LocaleContextHolder.getLocale());
        ...
        try {
            if (transactionDto.getPayment() != null && transactionDto.getPayment().getStatus().toString().equalsIgnoreCase("PAID")) {
                ...
                //detail pembayaran
                String paymentDetail = messageSource.getMessage("invoice.pulsa-detail-payment", null, LocaleContextHolder.getLocale());
                ...
                // waktu pembayaran
                String paymentTimeDetail = messageSource.getMessage("invoice.pulsa-date-payment", null, LocaleContextHolder.getLocale());
                ...
                detailPembayaran.addCell(stylePdfService.getTextDetail(" ", plusJakarta));
                detailPembayaran.addCell(stylePdfService.getTextDetail(" ", plusJakarta));
                String paymentMethod = messageSource.getMessage("invoice.pulsa-method-payment", null, LocaleContextHolder.getLocale());
...
//        String product = "Produk";
        String product = messageSource.getMessage("invoice.pulsa-produk", null, LocaleContextHolder.getLocale());
        detailProdukTbl.addCell(stylePdfService.getHeaderTextCell(product, plusJakarta));
        String desctiptionProduct = messageSource.getMessage("invoice.pulsa-deskripsi", null, LocaleContextHolder.getLocale());
        detailProdukTbl.addCell(stylePdfService.getHeaderTextCell(desctiptionProduct, plusJakarta));
        String quantity = messageSource.getMessage("invoice.pulsa-quantity", null, LocaleContextHolder.getLocale());
        detailProdukTbl.addCell(stylePdfService.getHeaderTextCell(quantity, plusJakarta).setTextAlignment(TextAlignment.CENTER));
        String price = messageSource.getMessage("invoice.pulsa-price", null, LocaleContextHolder.getLocale());
